...
#include "../include/routing_table_response.h"
#include "../include/update_response.h"
#include "../include/crash_response.h"
#include "../include/sendfile_manager.h"
#include "../include/sendfile_stats_response.h"
#include "../include/packet_resp.h"
...
bool control_recv_hook(int sock_index)
{
    ...
    switch(control_code){
        ...
        case 7: last_pak_response(sock_index);
                break;

        case 8: penultimate_pak_response(sock_index);
                break;
